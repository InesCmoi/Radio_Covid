...
if add_selectbox == 'Présentation du projet':
    ...
    st.markdown("Ce projet, a été réalisé en collaboration avec Ngoma Algy et Potrel Manuel")
...
# Conclusion of the project
    ...
    ccl_text_1 = 'Il semble que malgré les preprocessings testés, il ne soit pas aisé de supprimer tous \
    ...
    ccl_text_2 = 'Cette hypothèse de jeu biaisé se confirme en observant les zones d\'intéret selectionner par \
    l\'algorithme VGG16. En effet, sans préprocess le modèle selectionne principalement l\'information en dehors \
     des poumons. \
    Le zoom améliore la selection des zones d\'interets mais n\'est pas enore suffisant. \
    Enfin, après la segmentation Unet, le reseau de neurone se concentre principalement sur la forme des poumons \
    plutôt que sur l \'information qu\'ils contiennent.'

    st.markdown(ccl_text_1)

    from PIL import Image
    image = Image.open('deployment/VGG16_cam.png')

    st.image(image, caption='Iterprétabilité du modèle VGG16')
